...
export type CollectWithSigDataStructOutput = [string, BigNumber, BigNumber, string, EIP712SignatureStructOutput] & {
    collector: string;
    profileId: BigNumber;
    pubId: BigNumber;
    data: string;
...
export type FollowWithSigDataStructOutput = [string, BigNumber[], string[], EIP712SignatureStructOutput] & {
    follower: string;
...
export type PublicationStructStructOutput = [BigNumber, BigNumber, string, string, string, string] & {
    profileIdPointed: BigNumber;
    pubIdPointed: BigNumber;
    contentURI: string;
    referenceModule: string;
...
export type SetDefaultProfileWithSigDataStructOutput = [string, BigNumber, EIP712SignatureStructOutput] & {
    wallet: string;
    profileId: BigNumber;
    sig: EIP712SignatureStructOutput;
};
...
export type SetDispatcherWithSigDataStructOutput = [BigNumber, string, EIP712SignatureStructOutput] & {
    profileId: BigNumber;
    dispatcher: string;
    sig: EIP712SignatureStructOutput;
};
...
export type SetFollowModuleWithSigDataStructOutput = [BigNumber, string, string, EIP712SignatureStructOutput] & {
    profileId: BigNumber;
    followModule: string;
    followModuleInitData: string;
    sig: EIP712SignatureStructOutput;
...
export type SetFollowNFTURIWithSigDataStructOutput = [BigNumber, string, EIP712SignatureStructOutput] & {
    profileId: BigNumber;
    followNFTURI: string;
    sig: EIP712SignatureStructOutput;
};
...
export type SetProfileImageURIWithSigDataStructOutput = [BigNumber, string, EIP712SignatureStructOutput] & {
    profileId: BigNumber;
    imageURI: string;
    sig: EIP712SignatureStructOutput;
};
...
export interface LensHubInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'burnWithSig', values: [BigNumberish, EIP712SignatureStruct]): string;
    encodeFunctionData(functionFragment: 'collect', values: [BigNumberish, BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: 'collectWithSig', values: [CollectWithSigDataStruct]): string;
    encodeFunctionData(functionFragment: 'comment', values: [CommentDataStruct]): string;
    encodeFunctionData(functionFragment: 'commentWithSig', values: [CommentWithSigDataStruct]): string;
    encodeFunctionData(functionFragment: 'createProfile', values: [CreateProfileDataStruct]): string;
    ...
    encodeFunctionData(functionFragment: 'followWithSig', values: [FollowWithSigDataStruct]): string;
    ...
    encodeFunctionData(functionFragment: 'mirror', values: [MirrorDataStruct]): string;
    encodeFunctionData(functionFragment: 'mirrorWithSig', values: [MirrorWithSigDataStruct]): string;
    encodeFunctionData(functionFragment: 'name', values?: undefined): string;
    encodeFunctionData(functionFragment: 'ownerOf', values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: 'permit', values: [string, BigNumberish, EIP712SignatureStruct]): string;
    encodeFunctionData(
    ...
    encodeFunctionData(functionFragment: 'postWithSig', values: [PostWithSigDataStruct]): string;
    ...
    encodeFunctionData(functionFragment: 'setDispatcherWithSig', values: [SetDispatcherWithSigDataStruct]): string;
    ...
    encodeFunctionData(functionFragment: 'setFollowModuleWithSig', values: [SetFollowModuleWithSigDataStruct]): string;
    encodeFunctionData(functionFragment: 'setFollowNFTURI', values: [BigNumberish, string]): string;
    encodeFunctionData(functionFragment: 'setFollowNFTURIWithSig', values: [SetFollowNFTURIWithSigDataStruct]): string;
...
export interface LensHub extends BaseContract {
    ...
    functions: {
        ...
        getProfile(profileId: BigNumberish, overrides?: CallOverrides): Promise<[ProfileStructStructOutput]>;
        ...
        tokenDataOf(tokenId: BigNumberish, overrides?: CallOverrides): Promise<[TokenDataStructOutput]>;
    ...
    callStatic: {
        ...
        burnWithSig(tokenId: BigNumberish, sig: EIP712SignatureStruct, overrides?: CallOverrides): Promise<void>;
        ...
        collectWithSig(vars: CollectWithSigDataStruct, overrides?: CallOverrides): Promise<BigNumber>;

        comment(vars: CommentDataStruct, overrides?: CallOverrides): Promise<BigNumber>;

        commentWithSig(vars: CommentWithSigDataStruct, overrides?: CallOverrides): Promise<BigNumber>;

        createProfile(vars: CreateProfileDataStruct, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        followWithSig(vars: FollowWithSigDataStruct, overrides?: CallOverrides): Promise<BigNumber[]>;
        ...
        mirror(vars: MirrorDataStruct, overrides?: CallOverrides): Promise<BigNumber>;

        mirrorWithSig(vars: MirrorWithSigDataStruct, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        postWithSig(vars: PostWithSigDataStruct, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        setDefaultProfileWithSig(vars: SetDefaultProfileWithSigDataStruct, overrides?: CallOverrides): Promise<void>;

        setDispatcher(profileId: BigNumberish, dispatcher: string, overrides?: CallOverrides): Promise<void>;

        setDispatcherWithSig(vars: SetDispatcherWithSigDataStruct, overrides?: CallOverrides): Promise<void>;
        ...
        setFollowModuleWithSig(vars: SetFollowModuleWithSigDataStruct, overrides?: CallOverrides): Promise<void>;

        setFollowNFTURI(profileId: BigNumberish, followNFTURI: string, overrides?: CallOverrides): Promise<void>;

        setFollowNFTURIWithSig(vars: SetFollowNFTURIWithSigDataStruct, overrides?: CallOverrides): Promise<void>;
        ...
        setProfileImageURIWithSig(vars: SetProfileImageURIWithSigDataStruct, overrides?: CallOverrides): Promise<void>;
    ...
    estimateGas: {
        ...
        mirror(vars: MirrorDataStruct, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
        ...
        post(vars: PostDataStruct, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
